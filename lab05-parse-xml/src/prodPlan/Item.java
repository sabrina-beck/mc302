...
public class Item implements Comparable<Item> {
	...
	public String toString() {
		return MessageFormat.format("cod:{0} nome:{1} quantidade:{2} valor unitario:{3} valor:{4}", String.format("%d", this.parte.getCod()), this.parte.getNome(),
		        String.format("%d", this.quantidade), String.format("%.1f", this.parte.getValor()), String.format("%.1f", this.calculaValor()));
	}
